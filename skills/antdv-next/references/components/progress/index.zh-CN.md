...
## Demos
  ...
  - 进度条: demo/line.md
  - 进度圈: demo/circle.md
  - 小型进度条: demo/line-mini.md
  - 响应式进度圈: demo/circle-micro.md
  - 小型进度圈: demo/circle-mini.md
  - 动态展示: demo/dynamic.md
  - 自定义文字格式: demo/format.md
  - 仪表盘: demo/dashboard.md
  - 分段进度条: demo/segment.md
  - 边缘形状: demo/linecap.md
  - 自定义进度条渐变色: demo/gradient-line.md
  - 步骤进度条: demo/steps.md
  - 步骤进度圈: demo/circle-steps.md
  - 尺寸: demo/size.md
  - 改变进度数值位置: demo/info-position.md
