...
更多布局和导航的使用可以参考：[通用布局](../layout/docs.md)。
...
| Demo | Path |
| --- | --- |
| 顶部导航 | demo/horizontal.md |
| 内嵌菜单 | demo/inline.md |
| 缩起内嵌菜单 | demo/inline-collapsed.md |
| 只展开当前父级菜单 | demo/sider-current.md |
| 垂直菜单 | demo/vertical.md |
| 主题 | demo/theme.md |
| 子菜单主题 | demo/submenu-theme.md |
| 切换菜单类型 | demo/switch-mode.md |
| 自定义语义结构的样式和类 | demo/style-class.md |
| 自定义弹出框 | demo/custom-popup-render.md |
